"""
Common type definitions and protocols for the language learning module.
"""

from __future__ import annotations
from typing import Dict, List, Optional, Any, Sequence, Union, Protocol, runtime_checkable, TypedDict

# Type aliases for word entries
...
class PracticeResult(TypedDict):
    ...
    practiced_words: List[WordEntryType]
    correct: List[str]
    incorrect: List[str]
    score: float

# Vocabulary Trainer Protocol
@runtime_checkable
