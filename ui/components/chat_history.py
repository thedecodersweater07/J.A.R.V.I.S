...
class ChatHistory(tk.Frame):
    def __init__(self, master=None, theme_manager=None, **kwargs):
        super().__init__(master, **kwargs)
        self.theme_manager = theme_manager
        self.text = tk.Text(self, wrap=tk.WORD, state='disabled', bg='#23272e', fg='#e8eaed', font=("Consolas", 12))
    ...
    def render(self):
        ...
        if self.messages:
            ...
            text = "Welkom bij JARVIS. Hoe kan ik je helpen?"
    ...
    def _render_message(self, msg: Dict, index: int):
        ...
        window_width = 600  # imgui.get_window_width()
        ...
        self.text.configure(state='normal')
        self.text.insert(tk.END, f"{sender}")
        if timestamp:
    ...
    def add_message(self, sender, message, msg_type=None):
        self.text.configure(state='normal')
    ...
    def show_typing_indicator(self):
        self.add_message("JARVIS", "...", "assistant")

    def hide_typing_indicator(self):
        # Optionally remove typing indicator
        pass
